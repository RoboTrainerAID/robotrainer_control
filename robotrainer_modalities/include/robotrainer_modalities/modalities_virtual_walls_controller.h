#ifndef ROBOTRAINER_MODALITIES_VIRTUAL_WALLS_CONTROLLER_H
#define ROBOTRAINER_MODALITIES_VIRTUAL_WALLS_CONTROLLER_H

#include "robotrainer_modalities/modalities_controller_base.h"
#include "robotrainer_modalities/ModalitiesVirtualWallsControllerParameters.h"
#include "robotrainer_modalities/ModalitiesVirtualWallsControllerConfig.h"
...
{
	template <typename T> class ModalitiesVirtualWallsController : public robotrainer_modalities::ModalitiesControllerBase<T>{
		public:
				ModalitiesVirtualWallsController();
    ...
    protected:
			...
			bool use_modalities_virtual_walls_controller_;
...
// 			geometry_msgs::Twist limitVirtualForces(const robotrainer_helper_types::wrench_twist& hf_mv_msg, const robotrainer_helper_types::wrench_twist& vf_mv_msg);
		...
		private:
			...
			robotrainer_modalities::ModalitiesVirtualWallsControllerParameters params_;
			dynamic_reconfigure::Server<robotrainer_modalities::ModalitiesVirtualWallsControllerConfig> dynamic_reconfigure_server_;
			
			//FUNCTIONS
			void reconfigureRequest(const robotrainer_modalities::ModalitiesVirtualWallsControllerConfig& config, uint32_t level);
